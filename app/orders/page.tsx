  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-100 dark:bg-gray-900 p-6">
      ...
      <div className="flex space-x-6">
        ...
        <div className={`transition-all flex-1 ${isExpanded ? "h-screen" : "h-[500px]"} bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4`}>
          {/* 🔹 Selector de monedas */}
        ...
        <div className="w-80 bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4">
          ...
          <div className="flex flex-col space-y-3">
            ...
            <button className="p-2 mt-4 bg-green-500 text-white rounded hover:bg-green-600 transition">
              Buy {symbol.split(":")[1]}
            </button>
