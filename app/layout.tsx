                            ...
                            <div className="p-4 space-y-4">
                              <div className="flex items-center justify-between">
                                ...
                                <div className="flex flex-col items-end">
                                  <Badge variant="outline" className="bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400 mb-1">
                                    100% Uptime
                                  </Badge>
                            ...
                            <div className="p-4">
                              ...
                              <div className="py-4 space-y-4">
                                <div className="space-y-2">
                                  ...
                                  <div className="p-3 rounded-xl bg-gradient-to-br from-violet-500/10 to-indigo-500/10 dark:from-violet-500/20 dark:to-indigo-500/20 space-y-3 border border-violet-500/20 dark:border-violet-400/20">
                                    <div className="flex justify-between items-center">
