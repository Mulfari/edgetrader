  ...
  return (
    <html lang="es">
      <body className="min-h-screen bg-zinc-50/50 dark:bg-zinc-900">
        <ThemeProvider>
          {isLoading ? (
            <div className="fixed inset-0 flex items-center justify-center bg-zinc-50/50 dark:bg-zinc-900">
              <div className="flex flex-col items-center">
                <div className="w-16 h-16 bg-gradient-to-r from-violet-500 to-indigo-500 rounded-full flex items-center justify-center shadow-lg mb-4">
                  ...
                  `}>
                    <div className="flex flex-col h-full">
                      ...
                      <div className="h-16 px-6 flex items-center justify-between border-b border-zinc-200 dark:border-zinc-700/50">
                        ...
                        >
                          <Menu className={`h-5 w-5 transition-transform duration-300 ${isSidebarCollapsed ? 'rotate-180' : ''}`} />
                        </button>
                      </div>
                      ...
                      <div className="flex-1 overflow-y-auto">
                        <nav className="p-3 space-y-6">
                          ...
                          <div className="space-y-1">
                            ...
                            {menuItems
                              .filter(item => item.category === "configuración")
                              .map((item) => (
                                <Link 
                                  key={item.href}
                                  href={item.href} 
