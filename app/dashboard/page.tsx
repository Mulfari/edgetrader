...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-blue-950 animate-in fade-in-50 duration-500">
      {/* Mobile menu overlay */}
      {isMobileMenuOpen && (
        <div 
          className="fixed inset-0 bg-blue-950/60 backdrop-blur-sm z-40 lg:hidden animate-in fade-in-50 duration-300"
      ...
      {/* Sidebar */}
      <div className={`
        fixed top-0 left-0 z-50 h-full w-64 bg-white dark:bg-blue-950 border-r border-gray-200 dark:border-blue-800/30
        transform transition-transform duration-300 ease-in-out
        ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'}
      `}>
        <div className="flex flex-col h-full">
          <div className="p-4 border-b border-gray-200 dark:border-blue-800/30">
            <div className="flex items-center space-x-2">
              <div className="bg-gradient-to-r from-blue-600 to-indigo-600 w-8 h-8 rounded-md flex items-center justify-center shadow-md">
                <BarChart3 className="h-5 w-5 text-white animate-in fade-in-50 duration-500" />
              </div>
              <h1 className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-indigo-600 dark:from-blue-400 dark:to-indigo-400">TradingDash</h1>
            </div>
          </div>
          
          <div className="flex-1 overflow-y-auto py-4">
            <nav className="px-2 space-y-1">
              <a href="#" className="flex items-center px-3 py-2.5 text-sm font-medium rounded-md bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 group transition-all duration-200 hover:bg-blue-100 dark:hover:bg-blue-900/50 shadow-sm">
                <LayoutDashboard className="mr-3 h-5 w-5 text-blue-500 dark:text-blue-400" />
                Dashboard
              </a>
              <a href="#" className="flex items-center px-3 py-2.5 text-sm font-medium rounded-md text-gray-700 dark:text-blue-300/70 hover:bg-gray-100 dark:hover:bg-blue-900/20 group transition-all duration-200">
      ...
      <div className="lg:pl-64 transition-all duration-300">
        {/* Top navigation */}
        <header className="sticky top-0 z-30 bg-white dark:bg-blue-950 border-b border-gray-200 dark:border-blue-800/30 shadow-sm backdrop-blur-md bg-white/90 dark:bg-blue-950/90">
        ...
        <main className="py-6 px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4 mb-8">
            <div className="bg-white dark:bg-blue-950/20 overflow-hidden shadow-sm rounded-xl border border-gray-200 dark:border-blue-800/30 transition-all duration-200 hover:shadow-md animate-in slide-in-from-bottom-3 duration-500 delay-100">
              <div className="p-5">
                <div className="flex items-center">
                  <div className="flex-shrink-0 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-lg p-3 shadow-md">
              ...
              <div className="bg-gray-50 dark:bg-blue-900/20 px-5 py-3">
            ...
            <div className="bg-white dark:bg-blue-950/20 overflow-hidden shadow-sm rounded-xl border border-gray-200 dark:border-blue-800/30 transition-all duration-200 hover:shadow-md animate-in slide-in-from-bottom-3 duration-500 delay-200">
              <div className="p-5">
                <div className="flex items-center">
            ...
            <div className="bg-white dark:bg-blue-950/20 overflow-hidden shadow-sm rounded-xl border border-gray-200 dark:border-blue-800/30 transition-all duration-200 hover:shadow-md animate-in slide-in-from-bottom-3 duration-500 delay-300">
              <div className="p-5">
                <div className="flex items-center">
                  <div className="flex-shrink-0 bg-gradient-to-r from-purple-500 to-indigo-600 rounded-lg p-3 shadow-md">
            ...
            <div className="bg-white dark:bg-blue-950/20 overflow-hidden shadow-sm rounded-xl border border-gray-200 dark:border-blue-800/30 transition-all duration-200 hover:shadow-md animate-in slide-in-from-bottom-3 duration-500 delay-400">
              <div className="p-5">
                <div className="flex items-center">
          ...
          {/* Subaccounts section */}
          <div className="bg-white dark:bg-blue-950/20 shadow-sm rounded-xl border border-gray-200 dark:border-blue-800/30 overflow-hidden transition-all duration-200 hover:shadow-md animate-in slide-in-from-bottom-5 duration-500 delay-500">
            <div className="p-6">
